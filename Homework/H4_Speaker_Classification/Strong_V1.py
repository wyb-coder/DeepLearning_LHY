...
class Classifier(nn.Module):
    def __init__(self, d_model=256, n_spks=600, dropout=0.3):
        ...
        self.conformer = torchaudio.models.Conformer(
            input_dim=d_model,
            num_heads=8,           # 和你之前的 nhead=2 保持一致
            ffn_dim=1024,           # 和你之前的 dim_feedforward=256 保持一致
            num_layers=6,          # 和你之前的 num_layers=2 保持一致 (建议尝试 4 或 6)
...
def main(
    ...
    patience = 10  # 耐心值：允许模型连续多少次验证不涨分？(建议 10-20)
