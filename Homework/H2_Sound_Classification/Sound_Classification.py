...
train_ratio = 0.92  # the ratio of data used for training, the rest will be used for validation
...
# preprocess data
train_X, train_y = preprocess_data(split='train', feat_dir='./Data/libriphone/feat', phone_path='./Data/libriphone',
                                   concat_nframes=concat_nframes, train_ratio=train_ratio)
val_X, val_y = preprocess_data(split='val', feat_dir='./Data/libriphone/feat', phone_path='./Data/libriphone',
                               concat_nframes=concat_nframes, train_ratio=train_ratio)
...
# load data
test_X = preprocess_data(split='test', feat_dir='./Data/libriphone/feat', phone_path='./Data/libriphone',
